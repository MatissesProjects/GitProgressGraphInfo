...
4. The action will generate both `githeat.gif` (animated) and `githeat.png` (static) files in the root of your repository.

### Usage in Profile README
To display your GitHeat analytics in your GitHub profile README, add one of the following Markdown snippets:
