  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        const s = await chrome.storage.local.get(['theme', 'gridOrder', 'islandWrapAround', 'showTrends', 'customStart', 'customStop', 'showTicker', 'showPulseHash', 'showAvatar']);
